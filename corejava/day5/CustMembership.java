...
public class CustMembership implements Comparable<CustMembership> {
...
//	}
   ...
   public CustMembership(String name,int type,String date, double moneyspent) {
	   this.name=name;
	   this.type=type;
	   this.date=date;
...
@Override
public int compareTo(CustMembership o) {
	int codate;
	int comoney;
	if(type==o.type) {
